...
class KafkaProducer {
    ...
    private function __construct() {
        $configs = Tool::getConfig('kafka.' . SY_ENV . SY_PROJECT);
        ...
        $this->managerKey = Project::REDIS_PREFIX_MESSAGE_QUEUE . 'manager_kafka';
        $this->topics = [
            Project::MESSAGE_QUEUE_TOPIC_KAFKA_ADD_MYSQL_LOG,
        ];
    }
