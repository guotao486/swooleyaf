...
class UserAuthorizeInfo extends WxBaseShop {
    ...
    public function __construct(string $appId){
        parent::__construct();
        $this->urlAuthorizeBase = 'https://api.weixin.qq.com/sns/oauth2/access_token';
    ...
    public function getDetail() : array {
        ...
        $this->curlConfigs[CURLOPT_URL] = $this->urlAuthorizeBase . '?' . http_build_query($this->reqData);
