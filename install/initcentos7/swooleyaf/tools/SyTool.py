...
class SyTool():
    ...
    def installNginx():
        ...
        opensslLocal = ''.join([syDicts['path.package.local'], '/resources/nginx/openssl-1.0.2m.tar.gz'])
        opensslRemote = ''.join([syDicts['path.package.remote'], '/openssl-1.0.2m.tar.gz'])
        ...
        ngxluaLocal = ''.join([syDicts['path.package.local'], '/resources/nginx/lua-nginx-module-0.10.11.tar.gz'])
        ngxluaRemote = ''.join([syDicts['path.package.remote'], '/lua-nginx-module-0.10.11.tar.gz'])
    ...
    def installPhp7():
        ...
        php7Local = ''.join([syDicts['path.package.local'], '/resources/php7/php-7.1.17.tar.gz'])
        php7Remote = ''.join([syDicts['path.package.remote'], '/php-7.1.17.tar.gz'])
        ...
        # 扩展SeasLog
        extSeasLogLocal = ''.join([syDicts['path.package.local'], '/resources/php7/SeasLog-1.7.6.tgz'])
        extSeasLogRemote = ''.join([syDicts['path.package.remote'], '/SeasLog-1.7.6.tgz'])
